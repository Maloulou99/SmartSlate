...
#   - `--name SmartSlate`: This sets the name of the container to "SmartSlate".
...
#   - `-e MYSQL_ROOT_PASSWORD=Maloulou99`: This environment variable sets the root password for MySQL 'root' is default.
#   - `SmartSlate`: This specifies the name of the image to run.
